...
export default class AddLabType extends Component{
    ...
    onAddClick = event=>{
        ...
        alert("LabType Added SuccessFully");
    }

    render(){
        return <div>
                    <input type="button" data-toggle="modal" data-target="#myModalA" className="btn btn-primary" value="Add new Test" style={{width: "153px",border: "2px solid #ccc",fontSize: "14px",
    ...
    AddTest(obj){
        axios.post('http://localhost:3001/Laboratory/labtypes', obj)
    }
