...
export default class AddNewTestCategory extends Component{
    ...
    getNewState= () =>{
        ...
        return new Promise(function(resolve){
            h.setState({ getCurrentValue : {
                LabTestSubCategoryId : h.id  ,
                LabTestSubCategoryName : h.name   
            } })
    ...
    render(){
        return <div>
                    <input type="button" data-toggle="modal" data-target="#myModalAD" className="btn btn-primary" value="Add new Sub Category" style={{width: "210px",border: "2px solid #ccc",fontSize: "14px",
                            ...
                            <div className="modal-dialog" >
                                ...
                                <div className="modal-content" style={{border:"5px solid #1565c0",borderRadius:"9px",marginTop:"90px"}}>
                                    <div className="modal-header" style={{backgroundColor:"#1565c0" ,color:"#FFF"}}>
                                        ...
                                        <h4 className="modal-title">Manage Sub Category</h4>
                                    </div>
    ...
    AddCategory(obj){
        axios.post('http://localhost:3001/Laboratory/LabTestSubCategory', obj)
    }
